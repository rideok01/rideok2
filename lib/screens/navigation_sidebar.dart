...
import 'package:rideok2/screens/driver/screens/driver_page.dart';
import 'package:rideok2/screens/driver/screens/driver_profile.dart';
import 'package:rideok2/screens/main_screen.dart';
import 'package:rideok2/screens/tabs/earnings.dart';
...
class MainNavigation extends StatelessWidget {
   String? namee;
  String? emaill;
  MainNavigation({this.namee, this.emaill});
final padding = const EdgeInsets.symmetric(horizontal: 20);
  ...
  Widget build(BuildContext context) {
    ...
    return Drawer(
      child: Material(
        color: const Color.fromARGB(255, 104, 149, 251),
        child: ListView(
          children: <Widget>[
            buildHeader(
              urlImage: urlImage,
